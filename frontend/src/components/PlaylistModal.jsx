...
const PlaylistModal = () => {
  ...
  return (
    <div className="fixed inset-0 bg-[#0F0D13] z-9 flex flex-col lg:flex-row">
      ...
      <div className="lg:w-2/3 w-full flex flex-col p-6 overflow-y-auto">
        <div className="flex justify-between items-center border-b border-gray-600 pb-2 mb-2">
          <h3 className="text-white text-lg">
            Queue • {currentSongs.length} tracks • {formattedDuration}
          </h3>
          <button
          ...
          {currentSongs.map((song, index) => (
            <div
              ...
              <div className="flex items-center space-x-4">
                ...
                <button onClick={() => dispatch(removeSongFromQueue(song.id))}>
