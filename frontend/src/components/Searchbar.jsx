  ...
  return (
    <div className="relative w-[375px]">
      ...
      <form
        ...
        autoComplete="off"
        className="flex items-center bg-[#26242A] rounded-lg px-4 py-2 transition-all duration-200 hover:bg-[#2E2C34] border-2 border-transparent focus-within:border-[#8A86FF]">
        <FiSearch
